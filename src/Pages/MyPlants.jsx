...
const SkeletonRow = () => (
  <tr className="animate-pulse border-b">
    <td className="py-4 px-6">
      <div className="h-16 w-20 bg-gray-200 rounded-md"></div>
    </td>
    <td className="py-4 px-6">
    ...
    <td className="py-4 px-6 flex gap-3">
      <div className="h-9 bg-gray-300 w-20 rounded"></div>
      <div className="h-9 bg-gray-300 w-20 rounded"></div>
    </td>
  </tr>
);
    ...
    <div className="min-h-screen p-6">
      ...
      {dataLoading ? (
        <div className="overflow-x-auto">
          <table className="min-w-full border border-green-200 rounded-xl overflow-hidden shadow-md">
