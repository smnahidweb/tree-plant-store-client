  ...
  return (
    <section data-aos="fade-up" className="py-14 px-6 max-w-5xl mx-auto">
      ...
      {upcomingWateringPlants.length === 0 ? (
        <p className="text-center text-[var(--TEXT-COLOR)] text-lg">No plants need watering today. if you check the Functionality then in Add plant section, you give the todays date</p>
      ) : (
